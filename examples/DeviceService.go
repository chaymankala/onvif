...
import (
	...
	goonvif "github.com/chaymankala/onvif"
	"github.com/chaymankala/onvif/device"
	sdk "github.com/chaymankala/onvif/sdk/device"
	"github.com/chaymankala/onvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/chaymankala/onvif/gosoap for pretty printing response
